...
@Component({
  selector: 'app-maknooz-automatic-dates',
  imports: [CommonModule, RouterModule, FormsModule, CategoriesBarComponent],
  templateUrl: './maknooz-automatic-dates.html',
  styleUrl: './maknooz-automatic-dates.scss',
})
export class MaknoozAutomaticDates implements OnInit {
  products: any[] = [];
  categories: any[] = [];
  isLoading = true;
